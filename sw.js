...
(() => {
    ...
    const ejectDomain = 'blog.xixiranran.com'
...
search: false,
match: url => {
      return url.host === ejectDomain && url.pathname.match(/\/|\.(js|html|css|woff2|woff|ttf|cur)$/);
    }}
,
cdn: {
clean: true,
...
clean: true,
match: url =>
      url.host === ejectDomain && url.pathname.match(/(.*?)\.(png|jpe?g|svg|webp|gif|bmp|psd|tiff|tga|ico|eps)/)}
,
thirdparty: {
clean: true,
match: url => url.host === "bu.dusays.com" && url.pathname === "/2023/03/03/6401a79030db5.png"}
}
